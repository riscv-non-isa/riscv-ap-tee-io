...
The TSM returns the device connection transcript data to the host security domain
...
that is accessible to both the host security domain manager and the TSM.

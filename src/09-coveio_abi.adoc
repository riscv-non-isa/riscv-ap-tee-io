...
===== Function: CoVE Host Register PCIe Root Port (FID #1024)
[source, C]
-----
...
===== Function: CoVE Host Connect Device (FID #1025)
[source, C]
-----
...
===== Function: CoVE Host Disconnect Device (FID #1026)
[source, C]
-----
...
===== Function: CoVE Host Add TVM Interface Region (FID #1027)
[source, C]
-----
...
===== Function: CoVE Host Reclaim TVM Interface Region (FID #1028)
[source, C]
-----
...
===== Function: CoVE Host Bind Interface (FID #1029)
[source, C]
-----
